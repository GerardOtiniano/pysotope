...
# #         print("Linearity best model results EIV")
# #         print(best_model)
# #         print(popt)
# #         print(details)
# #         # if force_linearity_model is not None:
# #         #     best_model = force_linearity_model
...
# #             print("debug 7a")
# #             print(parabolic_func(xdata, *popt) )
...
#
#     print("Linearity best model results")
#     print(best_model)
#     print(y_fit)
#     print(xdata)
#     print(popt)
...
#
# from ..queries import *
# from ..queries import neg_response, pos_response
# from ..figures import *
# from ..base_functions import create_subfolder
# from ..curve_fitting import *
# from ..function_alignment import build_norm_with_fallback
...
def determine_linearity_model(norm, area_cutoff, dD_id, include_parabolic):
    """
    ...
    best_model, popt, sse, pcov = fit_and_select_best(
        x, y, include_parabolic=include_parabolic)
